...
const styles = StyleSheet.create({
  ...
  lanceCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, backgroundColor: '#f9f9f9', borderRadius: 8, marginBottom: 10, borderWidth: 1, borderColor: '#eee' },
  maiorLanceCard: { borderColor: '#27AE60', backgroundColor: '#EAF8F1' },
  lanceValor: { fontSize: 18, fontWeight: 'bold', color: '#333' },
  lanceComprador: { fontSize: 12, color: '#777', marginTop: 4 },
  badgeMaiorLance: { backgroundColor: '#27AE60', color: '#fff', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4, fontSize: 12, fontWeight: 'bold' },
  
  button: { backgroundColor: '#4B7BE5', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 'auto' },
